...
1. Create a new branch on local repo
...
3. Using git credentials

From [stackoverflow](https://stackoverflow.com/questions/1595848/configuring-git-over-ssh-to-login-once)
...
## Note this procedure after changing line endings in a repo
