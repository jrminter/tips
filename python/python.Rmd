...
title: "Python Tips"
author: "J. R. Minter"
date: 'Started: 2013-07-16, Last modified: 2021-03-27'
output:
  html_document:
...
I installed `Anaconda3-2020.11-MacOSX-x86_64.pkg` on my two macbooks.
The installation would work when I started it. If I ran updates, it
would bork the installation. I am not sure why...

I did not try a Windows installation.

**Note** I wanted to install **python 3.9** on my mac on 2021-03-27. 
I cannot seem to get above version **3.8**. My web seaches suggest
that I am not alone...
...
miniconda release. **Note** I have had issues on macos if I update the install...
