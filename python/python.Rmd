...
- Clean all source fikes: **conda clean --all** Can save > 1 Gb of space...
...
```
conda create -n py35qt4 python=3.5 qt=4 anaconda
...
7. Manage channels from the command line like this:
