...
- Run regedit and delete the keys **HKEY_LOCAL_MACHINE\\SOFTWARE\\Python** and **HKEY_CURRENT_USER\\Software\\Python**
...
7. I had an install fail to install the menus on my Kodak laptop. I have the shortcuts stored in my installer collection. They are all to be located in this folder:

```
%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\Anaconda3 [or Anaconda3 (64-bit)]
```
