...
## installing theano on Anaconda Py35
...
We will install the latest Anaconda Python 3.5 environment as a primary environment and use `conda` to create a Python 2.7 environment. This will provide a way to get whatever versiobn of python you want and have them all play nicely together. We want to start with a clean slate...
