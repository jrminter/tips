...
title: "Windows Tips"
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2017-10-29"
output:
  knitr:::html_vignette:
...
If you forgot to do this programs that you need for the
workshop will not work properly. If this happens rerun the installer
...
3. Add `C:\Program Files\Sublime Text 3` to your path. You will then
be able to edit the python file `foo.py` by typing
