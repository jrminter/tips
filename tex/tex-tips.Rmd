...
title: "LaTeX Hints"
author: "J. R. Minter"
date: 'Started: 2013-07-16, Last modified: 2022-01-09'
output:
  html_document:
...
1. On my win 10 box latex documents are in
    ...
    ```
    ```
    Update texlive with from the command promopt with:
...
2. A **great place to start** from [Andy Roberts tips](https://www.andy-roberts.net/writing/latex)

3. A nice help on page margins from [overleaf ](https://www.overleaf.com/learn/latex/page_size_and_margins).

4. Helpful Koma examples
...
5. From `TeX and Typography` `@TeXtip`    

   You cannot use `\\` to produce a backslash. Use $\backslash$ instead.

6. A couple of good hints for problems
