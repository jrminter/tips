...
2. Install 64 bit Anaconda to **C:\\Apps\\miniconda**  - check both
checkboxes during the install (it writes the 64 bit python to the registry).

3. Rename **C:\\Apps\\miniconda** to **C:\\Apps\\miniconda-64**

4. Install 32 bit Anaconda to **C:\\Apps\\miniconda** - check both
checkboxes during the install (it writes the 64 bit python to the registry).
