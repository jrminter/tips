...
author: "John Minter"
date: 'Original: 2021-12-13 Updated: 2022-02-23'
output:
  html_document:
    toc: no
    toc_depth: '3'
...
# Apple Care on the Watch

Apple Care is billed **monthly**

# Apple instructions for calibrating the Apple watch distance

Instructions are [here](https://support.apple.com/en-us/HT204516).
At the moment my Sole Treadmill reads 5.0 mi and the Apple Watch reads 4.3 mi.
