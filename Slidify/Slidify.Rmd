...
**2015-05-04 Note:** There is an inmcompatibility between the latest version of `Slidify` and the release version of `stringr` caused by a problem with processing regular expressions. The current workaround is to install `stringr-0.6.2` from the `CRAN` archives.
