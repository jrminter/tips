...
author: "J. R. Minter"
date: "Started: 2016-01-20, Last modified: 2018-06-14"
output:
  html_document:
...
plt_mod1 <- base_plot +
			scale_x_date(limits = as.Date(c("1980-01-01",
											"2000-01-01"))) +
...
cyclerPlt <- ggplot(dfTidy, aes(x=TRT, y=CPK, fill=Gender)) +
					...
					theme(axis.text=element_text(size=12),
						  ...
						  plot.title=element_text(hjust = 0.5)) # ce
...
if (bSave == TRUE) {
	ggsave("./dat/png/grain-ecd-shape-boxplot.png",
		   plot=pBPECDAR, width=6, height=4,
		   units="in", dpi=150)
}
print(pBPECDAR)
```
