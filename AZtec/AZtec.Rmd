...
We really want to do our calibration with **Cu** for high voltage anlysis and, **Mn** for low voltage. A BAM multielement standard would likely be more helpful where there are line overlaps over a range of voltages.
