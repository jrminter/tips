...
title: "AZtec Tips"
author: "J. R. Minter"
date: "Started 2014-09-09, Last modified: 2017-12-11"
output:
  knitr:::html_vignette:
...
2. Start the License Product Tool from the Oxford Instruments NanoAnalysis folder 
...
6. Wait a few seconds for the licence activation server to be contacted over the internet. 
...
10. Wait a few seconds while the license activation server prepares the licence. 
11. A message will be displayed when the licence has been successfully saved. 
