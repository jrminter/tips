...
title: "Fitness tips"
author: "J. R. Minter"
date: "Started: 2015-05-10, Last modified: 2021-09-06"
output:
  html_document:
...
1. Start by turning your FITBIT Ionic watch off. To do that, hold the
**left-hand** and the **lower right-hand** side buttons together.
The watch should turn off after 10 seconds.
...
**N.B.** this should be all that is needed.
...
fitbit app on the iPhone. **pull down** on the screen in the FitBit
app. A nessage will appear: **synching your ionic**.
...
[R-Bloggers](https://www.r-bloggers.com/2021/05/fitbit-visualizations-using-the-fitbitviz-r-package/) had some helpful ideas.
