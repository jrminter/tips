...
author: "Stian Haklev"
date: "Original: 2014-10-14, Entered: 2014-11-23, Last modified: 2017-10-28"
output:
  knitr:::html_vignette:
...
From [here](http://reganmian.net/blog/2014/10/14/starting-data-analysiswrangling-with-r-things-i-wish-id-been-told/)

[Back to Index](../README.html)

***About the author***

Stian Haklev is a PhD student at University of Toronto. He grew up in Norway, and have also spent significant time working and studying in Italy, Sweden, China, Indonesia and Mexico. His undergraduate degree was in International Development Studies at University of Toronto at Scarborough. He did a MA thesis in the Higher Education Program at OISE, with Dr. Ruth Hayhoe and Dr. Jim Slotta. His thesis focused on the Chinese National Top Level Courses project. In September 2010, he began a PhD in the Department of Curriculum, Teaching and Learning at OISE, with Dr. Jim Slotta. His PhD will focus on how to enable collaborative peer-based learning around Open Educational Resources.
...
![](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_whole-05.png)
...
So here are some of my suggestions and "lessons learned", in no particular order. Some will find the code samples scary, others will find the suggestion to use for-loops far too basic, but hopefully you will find something useful here.

<!-- more -->

# Use RStudio

![](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told-_-whole-01.png)
...
There's even a version of RStudio [that runs in the browser](http://www.rstudio.com/ide/docs/server/getting_started) â€“ we're currently using it to coordinate data analysis among a geographically dispersed team on many gigabytes of data. Keeping it on a central server, and letting people run analyses directly on the data is much more convenient and secure than having everyone store tens of gigabytes of data on their personal computers.
...
![](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_whole-04.png)

Running `Knit HTML` combines the text, formatted nicely, the code used to generate the graph, and the actual graph:

![](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_whole-03.png)
...
[![](images/2014-10-14-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_whole-01.png)](http://rpubs.com/)
...
![](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_whole-06.png)
...
![](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_whole-07.png)

# Use version control

![ version control](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_half-02.png)
...
![](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_whole-08.png)
...
[![right ](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_half-03.png)](images/2013-10-09-starting-data-analysiswrangling-with-r-things-i-wish-id-been-told_-_half-03-orig.png)
