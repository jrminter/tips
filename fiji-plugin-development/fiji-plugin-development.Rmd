...
author: "J. R. Minter"
date: "Started: 2019-05-05, Last modified: 2019-05-06"
output:
  html_document:
...
but do not work when called from jython scripts. When isntalled, they do not
...
2. One should not use **spaces** or **dashes** in Artifact ID (i.e. plugin name).
    ...
    Curtis Reuden notes that a '_' character is acceptible.
