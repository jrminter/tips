...
title: "Octave Tips"
author: "J. R. Minter"
date: 'Started: 2019-03-21, Last modified: 2021-05-21'
output:
  html_document:
...
The current version of Gnu Octave is 6.2.0 (as pf 2021-05-07)

1. [Part 1](https://www.youtube.com/watch?v=5MLuYGdEYzg&list=PLCq1Hx5o5Rk0UH6Bnxx7OednyhVPOEgyj)

- A great [Octave playlist](https://www.youtube.com/playlist?list=PLCq1Hx5o5Rk0UH6Bnxx7OednyhVPOEgyj) by Nicholas N.

- Try [this](https://wiki.octave.org/wiki/index.php?title=Tips_and_tricks)


- [This site](https://stackoverflow.com/questions/38593663/how-can-i-start-octave-from-the-command-line-and-not-the-gui) helped set up paths...


- [Octave Packages from SourceForge](https://octave.sourceforge.io/packages.php)
