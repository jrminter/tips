...
author: "J. R. Minter"
date: "Started: 2016-12-08, Last modified: 2019-05-01"
output:
  html_document:
...
4. For $\LaTeX$ math, the
[AOPS](http://artofproblemsolving.com/wiki/index.php/LaTeX:Commands) site.

5. The `Liberate Science` [rmarkdown workshop](https://github.com/libscie/rmarkdown-workshop)
repository on github.

6. A nice article by [www.accelebrate.com](https://www.accelebrate.com/library/how-to-articles/r-rstudio-library) on library paths in RStudio.

7. A nice article on R/RStudio in
