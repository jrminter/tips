...
author: "J. R. Minter"
date: "Started: 2016-12-08, Last modified: 2021-06-19"
output:
  html_document:
...
Alison Hill has a nice Youtube video [here](https://www.youtube.com/watch?v=sxYE0BY1mdc).

Yihui Xie has the [The R Markdown Cookbook](https://bookdown.org/yihui/rmarkdown-cookbook/)

## Some key tips

1. For PDF documents

generate a page break with
...
2. Control the width of the HTML output
...
3. Render markdown code in a RMarkdown Document
...
9. Find the version of `pandoc` used by RStudio:


    ```{r findRstudioPandoc, include=TRUE}
