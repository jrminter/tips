...
Let's start by loading a dataframe from disk and compute the derived quantity we
need to plot. We want to use the LOESS algorithm to compute a smooth, monotonic
curve. The values from this curve maty be used as a look-up table to compute
