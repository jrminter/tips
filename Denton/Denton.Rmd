...
7. The power turns off automatically when using the timed mode. If in manual mode, push STOP botton when sufficient **ETCH** time has elapsed.
...
2. If during sputtering, the sputterhead must be taken apart and the thin Teflon disc cleaned.
