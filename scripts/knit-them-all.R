...
names <- c("README.Rmd",
           ...
           "EDAX.Rmd", "Excel.Rmd","fitness.Rmd", "french-press-instructions.Rmd",
           "gfortran.Rmd",
           ...
           "R-lm.Rmd", "R-loess.Rmd",
           "R-markdown.Rmd", "R-matrix-algebra.Rmd",
...
rPath <- c("../",
           ...
           "../EDAX", "../Excel", "../fitness", "../french-press-instructions",
