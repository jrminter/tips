...
names <- c("README.Rmd",
           ...
           "json.Rmd","Legacy.Rmd", "Logos.Rmd", "Low-Carb-Diet.Rmd",
           "Lubuntu.Rmd", "mac.Rmd", "mac-for-data-science.Rmd",
           "micro.Rmd", "micro-sample-prep.Rmd", "midb.Rmd", 
           "monteCarlo.Rmd", "msOffice.Rmd", 
           "mysql.Rmd", "Octave.Rmd", "Oracle-Virtual-Box.Rmd",
           "osPkgs.Rmd", "pandoc.Rmd",
           "plagiarism.Rmd", "pool.Rmd", "portableMakefiles.Rmd",
           ...
           "R-model-predict.Rmd","R-packages.Rmd", "R-scrape-pdf.Rmd",
...
rPath <- c("../",
           ...
           "../EDAX", "../Excel", "../fiji-plugin-development",
           "../epma-matrix-corr",
           ...
           "../json","../legacy", "../Logos", "../Low-Carb-Diet", 
           "../Lubuntu", "../mac", "../mac-for-data-science",
           "../micro", "../micro-sample-prep" , "../midb", 
           "../monteCarlo",  "../msOffice",
           "../mysql", "../Octave", "../Oracle-Virtual-Box",
           "../osPkgs", "../pandoc",
           "../plagiarism","../pool" , "../portableMakefiles",
           ...
           "../R-model-predict", "../R-packages", "R-scrape-pdf",
