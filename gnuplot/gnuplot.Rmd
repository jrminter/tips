...
title: "Gnuplot Tips"
author: "J. R. Minter"
date: "Started: 2013-07-20, Last modified: 2021-04-28"
output:
  html_document:
...
1. I found new gnuplot binaries [here](http://ctan.ijs.si/mirror/w32tex/w32/). Worth checking out...

2. To the best of my knowledge, I think the latest `gnuplot` Windows
   binary is `gp541-win64-mingw.exe`. One can get this from
...
```
C:/Users/johnr/Dropbox/gnuploy/gnuplot-penepma16
```
