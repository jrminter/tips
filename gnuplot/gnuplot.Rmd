...
title: "Gnuplot Tips"
author: "J. R. Minter"
date: "Started: 2013-07-20, Last modified: 2020-08-26"
output:
  html_document:
...
I am having terrible problems with Gnuplot on Windows 10. The windows
application crashes on both my  desktop and VM on mac. I have no idea
why...

## Direct output to png

On Windows, I usually set gnuplot output to print to a Windows terminal.
I sometimes write to postscript, but recently I have been writing png
output directly. Given my recent problems on Windows, this exampleAn
example is timely...:


```
# set terminal png size 1024,768 font "Arial,12"
# set output "DTSA-MoS2-Pb-Mo-FeS2-15kV-lin.png"
```
...
Thsi is `proc-gnuplot` on the mac
...
1. The gray bar on the Windows GUI has icons that send common commands
   to the terminal.
    ...
    Defaults:    
    GraphOrigin=208 208    
    GraphSize=1424 765   I changed to 1024 758    
