...
title: "Gnuplot Tips"
author: "J. R. Minter"
date: "Started: 2013-07-20, Last modified: 2021-05-09"
output:
  html_document:
...
1. I found new gnuplot binaries [here](http://ctan.ijs.si/mirror/w32tex/w32/).
Worth checking out... This is hosted by the Josef Stefan Institute in Slovenia.
They provide win32 and win64 binaries.

2. To the best of my knowledge, I think the latest `gnuplot` Windows
   binary is `gp542-win64-mingw.exe`. One can get this from
   [Sourceforge](https://sourceforge.net/projects/gnuplot/files/gnuplot/testing/).
   
   Mac binaries are available via Homebrew  with
   
   ```
   brew install gnuplot
   ```
   
   There is also a binary package of [gnuplot-5.4.1.pkg](https://ariadne.ms.northwestern.edu/Download/Gnuplot/gnuplot-5.4.1.pkg) here.

2. [Vanderbilt physics](https://my.vanderbilt.edu/physicslabs/gnuplot-tutorial/) tutorial

4. [Raymii.org](https://raymii.org/s/tutorials/GNUplot_tips_for_nice_looking_charts_from_a_CSV_file.html)

5. [Clark University tutorial](http://physics.clarku.edu/sip/tutorials/gnuplot/)

6. [SMU Physics](http://www.physics.smu.edu/fattarus/GnuplotTutorial.html)

7. [gnuplotting.org](http://www.gnuplotting.org/output-terminals/) Not `https`...
...
## An example from my Win10 system

1. I used the following path

```
C:/Users/johnr/Dropbox/gnuplot/gnuplot-penepma16
```

2. I used the data file `pe-spect-01.dat`

3. I used a script in
...
Note that this works on Mac and Windows10. Note the path to the  `gnuplot`
program...
...
if (Sys.info()[1] == 'Windows'){
  print("windows")
  gp <- pipe('C:/Apps/gnuplot/bin/gnuplot','w')
