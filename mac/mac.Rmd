...
jrminter 6: brew list
autoconf    harfbuzz     pandoc
automake    icu4c        pango
cairo       imagemagick  pcre
cvs         jpeg         pdflib-lite
fontconfig  libffi       pixman
freetype    libpng       pkg-config
gd          libtiff      readline
gettext     libtool			 webp
glib        lua          xz
gnuplot     mysql
gobject-introspection    openssl
...
**5: Option-volume control on top bar**  lets get preferences
