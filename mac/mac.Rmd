...
title: "MacOS Tips"
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2018-01-06"
output:
  knitr:::html_vignette:
...
1. Before starting the Win 10 VM, use CMD+Option to hide the dock.
...
5. When done with the VM, exit FS mode and shut down. Use CMD+Option to
restore the dock.
