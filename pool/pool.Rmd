...
are still on the original liner.
...
and a flocculent (get details from Eileen). We added the chemicals they,
suggested, ran the filter for 2 hrs as recommended, and turned it off for
two days as recommended. 

Three days later it was still cloudy, so we vacuumed to waste as directed and
