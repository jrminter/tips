...
author: "J. R. Minter"
date: "Started: 2015-02-13, Last modified: 2021-06-19"
output:
  html_document:
...
I ended up doing this on macOS

macOS setup (MacBook Pro 2012 - still need to do the new mac...)

I ended up with this. Note I took the space out of the name...
...
ln -s "/Applications/SublimeText4.app/Contents/SharedSupport/bin/subl" /usr/local/bin/subl
```
