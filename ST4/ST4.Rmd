---
title: "Sublime Text 4 Tips"
author: "J. R. Minter"
date: "Started: 2015-02-13, Last modified: 2022-02-27"
output:
  html_document:
...
# Setup Sublime Text 4 on Mac

This helpful information came from [sourabhbajaj.com](https://sourabhbajaj.com/mac-setup/SublimeText/README.html) :
...
# John Minter's tips for ST4

Today, I found out that Sublime Text allows you to check spelling. To enable
spell-check: click `F6` or go to `View`->`Spell Check`.

When spell-check is enabled, it displays red squiggles below the misspelled
words. By right click on misspelled word you can correct the misspellings.
You can also ignore it for all other occurrences of specific word (useful e.g.
for Software Projects names).



These are John Minter's tips for using the editor ``Sublime Text 4``.

**Note** ST4 was released and I purchased on `2021-05-21`. This file needs
more updates.
...
Sublime Text 4 is the current version of Sublime Text. For bleeding-edge
releases, see the dev builds. 

The changelog is [here](https://www.sublimetext.com/download).

```
Version: Build 4107 (I installed this version)
...
# ST4 Installation on Windows 10

1. Open the Start Menu and type `environ``

2. Select the item Edit the system environment variables

3. Click the button Environment Variables at the bottom of the
...
4. Select, or create, the Path environment variable in the appropriate section:
   ...
   - Click the New button and add an entry with the Sublime Text installation
     directory

   - 64 bit installs are typically in `C:\Program Files\Sublime Text\`

   - 32 bit installs on a 64bit version of Windows will be in    
     `C:\Program Files (x86)\Sublime Text\`
     
   - 32 bit installs on a 32bit version of Windows will be in    
     `C:\Program Files\Sublime Text\`

# Spell checking

Today, I found out that SublimeText allows you to check spelling. To enable
spell-check: click `F6` or go to `View->Spell Check`.
...
A. Documentation 
   ...
   - [Main Page](https://www.sublimetext.com/blog/articles/sublime-text-4)
   
   - [Documentation](https://www.sublimetext.com/docs/index.html)
   
   - [docs.sublimetext.io](https://docs.sublimetext.io/)
   
   - [The Book](https://sublimetextbook.com/)
