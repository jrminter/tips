...
title: "R Tips"
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2018-07-14"
output:
  knitr:::html_vignette:
...
```
bookings %>%
  filter(price-per_night) %>% 
  select(room_nights, revie_score) %>% 
  head(2)
```

Pipes are not news. Note that the Linux/Unix shell has been piping
