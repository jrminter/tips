...
Odd. I can run the latest RStudio (1.2.1280)
on my Win7 box (after cleaning out all the files in Appdata and
my home directory and running ccleaner on the registry).

On my Win10
Pro VM in Parallels 1.2.1280 pandoc gives me the access error.
There RStudio 1.2.1186 works.

```
C:\Program Files\RStudio\bin\pandoc>pandoc --version
pandoc 2.5
Compiled with pandoc-types 1.17.5.4, texmath 0.11.1.2, skylighting 0.7.4
Default user data directory: C:\Users\jrminter\AppData\Roaming\pandoc
