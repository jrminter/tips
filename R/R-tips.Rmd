...
title: "R Tips"
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2019-03-12"
output:
  html_document:
...
On my Win7 box and Parallels Win10 VM on Mac with RStudio 1.2.1302
has pandoc access errors. It turns out that pandoc 2.5 32 bit seems
to work on both systems. Had some help from comments from
[here](https://github.com/rstudio/rstudio/issues/3661). Some had
better success with x64 version. Go figure...

Install the desired binaries in the RStudio pandoc directory,
...
```
Currently running with pandoc32 on My win7 box
