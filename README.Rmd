...
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2021-04-12"
output:
  html_document:
    keep_md: true
...
6. Delete VLC play list

    Select the entry to delete and press clear.


7. [Big Sur update bricks my MBP model](https://apple.slashdot.org/story/20/11/16/0137234/macos-big-sur-update-reportedly-bricks-some-older-macbook-pros)

8. [RStudio 1.4 preview citations](https://www.r-bloggers.com/2020/11/rstudio-1-4-preview-citations)


9. **LaTeX Symbols to remember**
...
11. **Fix for annoying git message:**
...
13. From [DataArtisan](https://twitter.com/dataartisan1/status/1263784688432398338):
...
14. Checking Author/date properties in a PDF
...
15. Key greek and other characters
...
17. Chrome Bookmarks - How to move a folder...
...
18. Keyboard shortcut for the `dplyr` pipe operator
...
19. Fix a `recurring github credential problem` - run:
...
20. The R `janitor` package is your friend. It cleans up
     non-standard column names .

21. CDC Corona Virus Recommendations
...
22. Closed captions in CBS All access
...
23. The Feynman technique of learning:
...
24. Install command line tools on MacOS

      `xcode-select --install`

25. Reset a Fitbit Ionic watch

    **See the instructions in the _fitness_ link.**

26. Regex for youtube time stamps. Useful in SublimeText3!

      `\d\d:\d\d`

27. Symbolic links. I always get this backwards...
...
32. Automatically download all files in a directory
...
33. How to block someone on Facebook
...
34. Convert `.mkv` to `.mp4` from the command line
