...
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2018-07-11"
output:
  html_document:
...
4. Automatically download all files in a directory
...
5. I **hate** the new Chome bookmark manager. Happliy we can turn it off. Thanks to [Jeff Kitchen](https://productforums.google.com/forum/#!topic/chrome/TVHpStVuxSc)
