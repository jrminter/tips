...
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2021-05-08"
output:
  html_document:
    keep_md: true
...
1. Block an email address on Gmail
...
2. An odd get error with synch. This worked to fix. Moved to top!

   ```
   git config pull.rebase false
   ```

3. Block a number on iPhone
...
4. Use ESV from Kindle for easier copy/paste

5. Turn on **Do Not Disturb** on the Mac
...
6. Reset a [Fitbit Ionic Watch](fitness/fitness.html)
...
10. [Big Sur update bricks my MBP model](https://apple.slashdot.org/story/20/11/16/0137234/macos-big-sur-update-reportedly-bricks-some-older-macbook-pros)
