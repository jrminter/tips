...
9. Delete VLC play list

    Select the entry to delete and press clear.


10. [RStudio 1.4 preview citations](https://www.r-bloggers.com/2020/11/rstudio-1-4-preview-citations)


11. **LaTeX Symbols to remember**
...
27. Regex for youtube time stamps. Useful in SublimeText3!

      `\d\d:\d\d`

28. Symbolic links. I always get this backwards...
...
33. Automatically download all files in a directory
...
34. How to block someone on Facebook
...
35. Convert `.mkv` to `.mp4` from the command line
...
37. [Getting started with VisualStudio Code](https://yushulx.medium.com/building-libtiff-with-libjpeg-on-windows-dbf544ef603e)
