...
title: "Helpful Tips"
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2021-12-17"
output:
  html_document:
    keep_md: yes
...
**Cleaning Stainless-Steel Coffee Mugs**  Use this link...  
```https://www.youtube.com/watch?v=FQttuPcSyG8```

Seems to be an adds problem...
...
# A funny Academic Translator

I found this on Twitter... It is funny!

| What they say               | What they mean           |
|-----------------------------|--------------------------|
Various sources | I forgot the name and author of one paper |
...
| The notes were meticulously transcribed | I was drunk and missed out at least seven pages |                  
| An extensive literature search | A quick Google search |
| A complex phenomenon | I don't understand |
| It is impossible to summarize simply | I still don't understand |
| Approaching the traditonal threshold for statistical significance | Not significant |
| More research is required   | I need funding           |

I thought this was funny in a Ph.D. Comics mode...
...
# A helpful quote from Adam Grant
...
Some helpful information from @CMSeeberger:

> Colin Seeberger    
> NEW in @NEJM:    
> 
> **2 doses of the Pfizer vaccine offer 88% protection** against
> symptomatic disease caused by the **delta variant**. Just slightly
> down from 94% against the alpha variant (B.1.1.7) that was first
> discovered in Britain & became dominant across the globe earlier this
> year.



[Set up R universe](https://ropensci.org/blog/2021/06/22/setup-runiverse/)
(from ROpenScience).
...
[Apple Watch](./AppleWatch/AppleWatch.html)

[Bladder Control](./bladder/Bladder-Control.html)
