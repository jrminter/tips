...
author: "J. R. Minter"
date: "Started: 2013-07-16, Last modified: 2021-04-07"
output:
  html_document:
    keep_md: true
...
*Countdown to expected appointment*
...
1. Use ESV from Kindle for easier copy/paste

2. Turn on **Do Not Disturb** on the Mac
...
3. Reset a [Fitbit Ionic Watch](fitness/fitness.html)

4. Convert foo.mkv to foo.mp4

   ```
ffmpeg -i title.mkv -c copy title.mp4
   ```

5. Delete VLC play list
