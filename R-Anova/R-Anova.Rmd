...
ANOVA is a statistical process for analysing the amount
...
effects should not be further analysed).
...
find a relevant answer with an information retreival 
...
Generlized Linear Models", 2nd ed., Sage, 2008.
