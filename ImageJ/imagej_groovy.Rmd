...
I ended up downloading the Windows zip file (rezipped installation and
stored it in  `Dropbox/groovy/groovy-2.5.7.7z` I install it
`C:/Apps/groovy` and created a batch file `start_groovy_console.bat`
that I install in `C:/Apps/local/path`. I created a Windows shortcut
`start_groovy_console` that sits on my desktop. )
