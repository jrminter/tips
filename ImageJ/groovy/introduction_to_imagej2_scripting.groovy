/*
 * Introduction to ImageJ Scripting with Groovy
 * ============================================
 *
 * authored by Curtis Rueden and Jan Eglinger for I2K 2018)
 * Downloaded 2019-06-05 from
 * https://raw.githubusercontent.com/imagej/i2k-2018/master/ImageJ_Scripting.groovy
 *
 *
...
#@ Integer(label="An integer!", style="scroll bar", min=0, max=3) someIntValue
