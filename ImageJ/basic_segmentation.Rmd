...
- preparation for segmentation: We need the tube to be filled in. Skeletization
...
`Exculude on edges` and `Add to Manager`, and then `OK`. Our tube skows
...
prints out the length in the `Results Table`. The value is 3164.106 (px?)  (1:51:39). It is all
macro-recordable...
